...
insert into users (id, email, name, password, username) values (1, 'tpetteford0@linkedin.com', 'Tomi', 'uN1~{O)+''}', 'tvenneur0');
insert into users (id, email, name, password, username) values (2, 'sdebeneditti1@icq.com', 'Silva', 'aH5_V1Oar1', 'sbrane1');
insert into users (id, email, name, password, username) values (3, 'jdelisle2@mysql.com', 'Janene', 'iK0>q/VzG$ePJ|', 'jjosuweit2');
insert into users (id, email, name, password, username) values (4, 'aspellecy3@google.nl', 'Aileen', 'bZ0sf6&d', 'amindenhall3');
insert into users (id, email, name, password, username) values (5, 'amatushevich4@nifty.com', 'Arne', 'zE5#8$x7"mk>', 'ahuet4');
insert into users (id, email, name, password, username) values (6, 'mallsobrook5@pbs.org', 'Marchall', 'vM1+)1e_2=', 'mantonnikov5');
